...
import org.asu.cse535.lookup.util.ImagetoTextConverter;
import org.asu.cse535.lookup.util.PackageManagerUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickSearchButton(View view) {
        ...
        EditText simpleEditText = (EditText) findViewById(R.id.productName);
            ...
            VisionRequestInitializer requestInitializer =
                    new VisionRequestInitializer("AIzaSyDbhiX7Yo5hXQMxobqEZ5HGHs0QKYOfffU") {
                        ...
                        protected void initializeVisionRequest(VisionRequest<?> visionRequest)
                            ...
                            String packageName = "org.asu.cse535.lookup";
    ...
    public void navigate(List<String> storesList) {
        ...
        if (strValue != null && !strValue.equals("")) {
            ...
            storesList.add(strValue);
        }

        Intent intent = new Intent(this.getApplicationContext(), ProductListActivity.class);
        intent.putExtra("storesList", (Serializable) storesList);
